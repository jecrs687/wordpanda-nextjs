            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
                    ...
                    <div className="md:w-1/2">
                        ...
                        >
                            Como um panda adora bambu, seu cérebro adora{' '}
                        ...
                        >
                            O WordPanda transforma assistir filmes e séries em uma poderosa ferramenta de aprendizado. Nossa tecnologia identifica palavras-chave nas legendas e cria exercícios personalizados para você enquanto se diverte.
                        </motion.p>
                            ...
                            {[
                                {
                                    ...
                                    description: "Associe palavras a contextos reais, não apenas memorizando listas.",
                                    color: "emerald"
                                },
                                {
                                    title: "Vocabulário em Contexto",
                                    description: "Veja como as palavras são usadas em situações autênticas e compreenda melhor.",
                                    color: "indigo"
                                },
                                {
                                    title: "Aprendizado Personalizado",
                                    description: "Algoritmos inteligentes adaptam os exercícios ao seu nível e progresso.",
                                    color: "amber"
                                }
                            ].map((item, index) => (
                                <motion.div
