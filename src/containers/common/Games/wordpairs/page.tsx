...
export default function WordPairsGame({ words, lang, mediaId }: {
    words: { word: string }[],
    lang: string,
    mediaId?: string
}) {
    ...
    if (!words.length && !lang) {
        return (
            <EmptyState
                ...
                message="We need words to create memory pairs. Please select a language or add more words to your collection."
            />
        );
    }
